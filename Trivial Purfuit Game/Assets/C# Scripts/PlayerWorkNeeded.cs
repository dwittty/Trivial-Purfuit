...
//        Debug.Log($"PlayerToken {activePlayerToken}"); // for debugging purposes.  Delete when done.
//        activePlayerToken.SetSpriteBasedOnCakeStatus(hasRedCake, hasBlueCake, hasGreenCake, hasWhiteCake, activePlayerToken); // passed PlayerToken activePlayerToken to PlayerToken via SetSpriteBasedOnCakeStatus
//    }
//}
